        ...
        <div class="container py-4 ">
            ...
            <div class="row justify-content-end align-items-start">
                ...
                <div class="container mt-4">
                    <div class="card card-menu shadow-sm p-4 mb-4 d-flex">
                        <div class="text-center mb-4">
                            <h4>Daftar Tamu </h4>
                            <p class="text-muted">
                                Gunakan saat ingin melihat daftar tamu yang telah melakukan reservasi maupun yang telah hadir di kantor.
                            </p>
                        </div>
                        <div class="row g-3 justify-content-center">
                            <div class="col-md-5">
                                <a class="btn btn-success btn-lg w-100" href="daftar-reservasi.php">
                                    List Daftar Rencana Kunjungan Tamu
                                </a>
                            </div>
                            <div class="col-md-5">
                                <a class="btn btn-danger btn-lg w-100" href="daftar-hadir.php">
                                    List Daftar Hadir
                                </a>
                            </div>
                        </div>
